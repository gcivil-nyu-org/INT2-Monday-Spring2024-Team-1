...
urlpatterns = [
    ...
    path("healthcareFacility/", views.hospital_staff_directory, name="hospital_staff_directory"),
    path("getFacilityDoctors/", views.get_facility_doctors, name="get_facility_doctors"),
