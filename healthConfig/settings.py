...
# S3 Bucket Keys
AWS_ACCESS_KEY_ID = os.environ["S3_BUCKET_ACCESS_KEY_ID"]
AWS_SECRET_ACCESS_KEY = os.environ["S3_BUCKET_SECRET_KEY"]
AWS_STORAGE_BUCKET_NAME = os.environ["S3_BUCKET_STORAGE_NAME"]
